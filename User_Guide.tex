...
% this file creates three similar user guides depending on the commend \deviceName
...
\newcommand{\ttvar}[2]{\noindent\textsf{\textbf{\textcolor{crongray}{#1} \prefix #2}}}%for variable declaration
\newcommand{\ttdef}[1]{\noindent\textsf{\textcolor{crongray}{\#{}define} \PREFIX #1}}%for definitions

\newcommand{\ugrev}{{1.8.7}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
