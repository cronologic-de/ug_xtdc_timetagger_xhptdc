...
\usepackage[font=montserrat,drawframe]{cronologicug}
...
\hyphenation{Time-Tagger xTDC xHPTDC cronologic TimeTagger4 time-stamps time-stamp}


\newcommand{\ttvar}[2]{\noindent\texttt{\textbf{\textcolor{crongrey}{#1} \prefix #2}}}%for variable declaration
\newcommand{\ttdef}[1]{\noindent\texttt{\textcolor{crongrey}{\mbox{\#{}define}} \PREFIX #1}}%for definitions

\newcommand{\ugrev}{{1.8.12rc}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\begin{document}
\RaggedRight
...
% 
	...
	\chapter{Revision History} 
		\noindent
		User Guide \hyperlink{ugrev}{\ugrev} as of 2024-01-09\\  % needs also be updated in UgRev.tex
	%	\\
