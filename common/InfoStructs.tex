...
\ifxHPTDC{
    ...
    \subsection{Structure \prefix clock\tu info}
        ...
        Source for the clock synthesizer is usually the 10~MHz on board oscillator. During initialization alternatively an external clock on J2 can be selected.
