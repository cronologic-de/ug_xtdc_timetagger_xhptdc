...
\begin{description}[style=nextline]
    ...
    \ifxHPTDC{
        \item[\cronvar{int}{auto\tu trigger\tu period}]
        \item[\cronvar{int}{auto\tu trigger\tu random\tu exponent}]
    ...
    \label{apidcoffset}
    \ifxHPTDC{
        \item[\cronvar{double}{threshold[\PREFIX TDC\tu CHANNEL\tu COUNT]}]
...
\ifxHPTDC{
    ...
    \ifxHPTDC{
        \item[\cronvar{\prefix channel}{adc\tu channel}]
    ...
    \ifxHPTDC{}{
        \itett{
            \item[\ttvar{\prefix delay\tu config}{
...
\begin{description}[style=nextline]
    ...
    \item[\cronvar{crono\tu bool\tu t}{negate}]
...
\begin{description}[style=nextline]
    ...
    \item[\cronvar{crono\tu bool\tu t}{rising}]
    \txh{
...
\ifxHPTDC{
    ...
    \begin{description}[style=nextline]
        \item[\cronvar{crono\tu bool\tu t}{enabled}]
        Enable grouping. Defaults to \texttt{false}.

        \item[\cronvar{int}{trigger\tu channel}]
        ...
        \item[\cronvar{int}{zero\tu channel}]
        ...
        \item[\cronvar{\longlong}{range\tu start}]
            Start of group range relative to the \texttt{trigger\tu channel}.
        \item[\cronvar{\longlong}{range\tu stop}]
