...
\subsection{Structure \prefix \ifxHPTDC{device\tu}{}configuration}
	...
	The supported range is -1.32V to +1.18V. This should be close to 50\% of the height of the input pulse. Examples for various signaling standards are defined as follows:\par
	\ifxHPTDC{
...
%%%%%%%%%%%%%%%%%%%%%%%% channel
	...
	\subsection{Structure \prefix channel}
		...
		\cronvar{crono\tu bool\tu t}{rising}\\
		\txh{
			Not applicable for \deviceName. Rising and/or falling edge are configured using the \prefix trigger structure. See section \ref{structtrigger}.
		}{
