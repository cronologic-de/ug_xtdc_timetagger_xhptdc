...
\begin{description}[style=nextline]
    ...
    The supported range is \SIrange{-1.27}{1.13}{\volt}. This should be close
...
\ifxHPTDC{
    ...
    \begin{tabular}{ll}
        ...
        \ttdef{\DCOFFSET P\tu CMOS} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu LVCMOS\tu 33} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu LVCMOS\tu 25} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu LVCMOS\tu 18} & \texttt{+0.90}\\
        \ttdef{\DCOFFSET P\tu TTL} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu LVTTL\tu 33} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu LVTTL\tu 25} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu SSTL\tu 3} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET P\tu SSTL\tu 2} & \texttt{+1.13}\\
        \ttdef{\DCOFFSET N\tu NIM} & \texttt{-0.35}\\
        \ttdef{\DCOFFSET N\tu CMOS} & \texttt{-1.27}\\
        \ttdef{\DCOFFSET N\tu LVCMOS\tu 33} & \texttt{-1.27}\\
        \ttdef{\DCOFFSET N\tu LVCMOS\tu 25} & \texttt{-1.25}\\
        \ttdef{\DCOFFSET N\tu LVCMOS\tu 18} & \texttt{-0.90}\\
        \ttdef{\DCOFFSET N\tu TTL} & \texttt{-1.27}\\
        \ttdef{\DCOFFSET N\tu LVTTL\tu 33} & \texttt{-1.27}\\
        \ttdef{\DCOFFSET N\tu LVTTL\tu 25} & \texttt{-1.25}\\
        \ttdef{\DCOFFSET N\tu SSTL\tu 3} & \texttt{-1.27}\\
