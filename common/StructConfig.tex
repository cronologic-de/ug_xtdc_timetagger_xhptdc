...
\subsection{Structure \prefix \ifxHPTDC{device\tu}{}configuration}
	...
	\ifxHPTDC{
		This defines whether grouping is used by the \textsf{read\tu hits()} method. \\
...
%%			\end{figure}
	...
	\ifxHPTDC{
		...
		\ifxHPTDC{This will be managed by the driver in a way that results in the board with the lowest serial number to become the master. 
		}{}
