...
\subsection{Structure \prefix \ifxHPTDC{device\tu}{}configuration}
	...
	\ifxHPTDC{} % does not exist for xHPTDC8
	{
		...
		\itett{
			Not applicable for the \deviceName. Rising and/or falling edge are configured using \prefix trigger\tu block. See section \ref{structtrigger}.
		}{
...
%%%%%%%%%%%%%%%%%%%%%%%% channel
	...
	\subsection{Structure \prefix channel}
		...
		\cronvar{crono\tu bool\tu t}{rising}\\
		\txh{
			Not applicable for \deviceName. Rising and/or falling edge are configured using \prefix trigger\tu block. See section \ref{structtrigger}.
		}{
