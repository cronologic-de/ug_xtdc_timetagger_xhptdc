...
\ifxHPTDC{}{
    The \deviceName\ is available as a PCIe plugin board (variant ``-PCIe'', see \hyperref{cp:order_information}{Ordering Information}) or as a desktop solution (variant ``-TBT'').
