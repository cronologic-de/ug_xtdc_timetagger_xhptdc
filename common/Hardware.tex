...
\ifxHPTDC{}{
    The \deviceName\ is available as a PCIe plugin board (variant ``-PCIe'', see Ordering Information) or as a desktop solution (variant ``-TBT''). The two variants are shown in Figure~\ref{fig:boards-overview}. For a detailed
    overview of the hardware of the TBT-variant, please refer to our respective \href{https://docs.cronologic.de/projects/tbt2pcie/}{online user guide}.
    ...
    \begin{figure}[!htb]
        ...
        \itett{
            ...
            \includegraphics[width=0.9\textwidth]{xtdc/figure/board-overview}
        }
