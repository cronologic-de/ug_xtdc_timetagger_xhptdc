...
\ifxHPTDC{
	\section{Synchronizing multiple boards}
		\label{multiboard}
		If more than eight TDC inputs are required, up to eight boards can be synchronises within a system. The boards must each receive a common 10~MHz clock on connector J2. 
		For systems of up to four boards cronoglic offers the ClockBox product that conveniently makes such clocks evailable inside the PC enclosure.
