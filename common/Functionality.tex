\txh{ %TimeTagger Version
    ...
    detect hits the signal has to be stable for more than one quantisation
    ...
    \SI{8}{\pico\second}.  The timestamps are recorded in integer multiples of
