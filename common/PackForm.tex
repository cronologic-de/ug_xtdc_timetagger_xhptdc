...
\section{Output Structure crono\tu packet}
	...
	Bit 5: Rollover. The time since start pulse exceeded the \itett{23}{24}-bit range that can be encoded in a data word. This word does not encode a measurement. 
