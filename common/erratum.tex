We found undesired behavior for Gen\,1 devices of the \deviceName.\par
...
are reported with the wrong polarity. \itett{}{To trigger this behavior you 
need to violate the \textsf{t\subscript{DPfull}} parameter of the board that 
states that for full resolution you may not have more than one pulse within a 
\SI{5}{\nano\second} interval.}\
