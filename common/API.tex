...
\section{Driver Information}
	...
	Pointers to an error code and message variable have to be provided. If error\tu code does not equal \ttdef{OK} = 0, the error message will contain what went wrong. For E.g. crono kernel was not properly installed. \par
