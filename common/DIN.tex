...
\section{Electrical Characteristics}
    ...
    Keep in mind, that the input baseline \textsf{V\subscript{Base}} is affected by the ratio of pulse length \textsf{t\subscript{Pulse}} to average pulse distance (for continuous signals the term is called duty cycle).\par
	\ifxHPTDC{
...
Make sure not to drive the inputs when the connector is configured as a TiGer output.\par 
	}
