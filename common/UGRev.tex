...
\begin{xltabular}{\textwidth}{|c|c|X|}
    ...
    \hypertarget{ugrev}{1.8.16-rc} & 2024-06-11 &
    \makecell[l]{
        TimeTagger4: Added documentation for 10G calibration tool\\*
        xTDC4 and TimeTagger4: Added LED documentation\\*
        xHPTDC8: Fixed default values for \texttt{zero\_channel}\\*
        Clarifications for TiGer blocks indices\\*
        Updated \texttt{dc\_offset range}\\*
    }\\
    \hline
    {1.8.15} & 2024-05-08 &
    \makecell[l]{
