...
Each digital LEMO-00 input can be used as a \ifxHPTDC{AC coupled}{LVCMOS} trigger output. The TiGer function can be configured independently for each connector. 
