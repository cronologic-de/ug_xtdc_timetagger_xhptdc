...
\section{TDC Characteristics}
	...
	\subsection{TDC measurement Characteristics}
		...
		\begin{tabularx}{\textwidth}{|c|X|c|c|c|c|}
			...
			\hline
			t\subscript{DPfull} & distance betwenn edges for full resolution & 5 &  & & ns \\
			\hline
			t\subscript{DPCC} & distance betwenn edges for carry chain TDC & 10 &  & & ns \\
			\hline
			t\subscript{DPlow} & distance betwenn edges for lowres measurements & 1.8 &  & & ns \\
			\hline
