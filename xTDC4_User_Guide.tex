% This file is used to create a xTDC4 user guide with the correct file
% name and device name
%
% User guide for the cronologic GmbH & Co. KG xTDC4 boards.
%
% compile with
...
\newcommand{\adeviceName}{an xTDC4}
